...
public class CassandraType
{
    ...
    @Inject
    public CassandraType(TypeManager typeManager)
    {
    ...
    private Block buildTupleValue(CassandraTypeMapping type, GettableByIndex row, int position)
    {
        ...
        for (CassandraTypeMapping argumentType : type.getArgumentTypes()) {
            ...
            NullableValue value = getColumnValue(type, tupleValue, tuplePosition, () -> tupleValue.getType().getComponentTypes().get(finalTuplePosition));
